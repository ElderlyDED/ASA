...
public class WeaponSwitcher : MonoBehaviour
{
        ...
        foreach (Transform _weapon in _equipmentWeapons)
        {
            if (i == _selectSlot)
            {
                ...
                if (_weapon != _lastWeapon)
                {
                    ...
                    _weaponHolder.GetComponent<AudioSource>().Play();
    ...
    void UpStartGun()
    {
        ...
        _weaponGUI.WeaponSlotsSwitch(_firstGunUp.GetComponent<GetGUIWeaponSlotInf>().WeaponSlotId);
        _weaponGUI.WeaponAmmoGuiSwitch(_firstGunUp.GetComponent<WeaponAmmo>(), _firstGunUp.GetComponent<GetGUIWeaponSlotInf>());
    }
